...
import com.tpcstld.twozerogame.MainView.OnMainViewEventListener;
import com.tpcstld.twozerogame.bluetooth.DeviceListActivity;
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (!hasMoved) {
                    ...
                    } else if (iconPressed(mView.sXScan, mView.sYIcons)) {
                    	if(mOnMainViewEventListener != null){
                    		mOnMainViewEventListener.onIconScanClicked();
                    	}
                    }else if (iconPressed(mView.sXDiscoverable, mView.sYIcons)) {
                    	if(mOnMainViewEventListener != null){
                    		mOnMainViewEventListener.onIconDiscoverableClicked();
                    	}
