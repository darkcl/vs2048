...
import com.tpcstld.twozerogame.MainGame.OnGameEventListener;
...
public class MainView extends View {
    ...
    private Drawable scanIcon;
    private Drawable discoverableIcon;
...
//    private OnMainViewEventListener mOnMainViewEventListener = null;
    private InputListener mInputListener = null;

    public interface OnMainViewEventListener {
		public void onIconScanClicked();
		public void onIconDiscoverableClicked();
	}
    
    public void setOnMainViewEventListener(OnMainViewEventListener listener){
//		this.mOnMainViewEventListener = listener;
		mInputListener.setOnMainViewEventListener(listener);
	}
    ...
    public void updateConnectionStatus(String status){
    	...
    	Log.d("emma", "updateConnectionStatus:"+status);
        invalidate();
    }
    ...
    private void drawScanAndDiscoverableButton(Canvas canvas) {
        drawDrawable(canvas, backgroundRectangle, sXScan, sYIcons, sXScan + iconSize, sYIcons + iconSize);
        drawDrawable(canvas, scanIcon, sXScan+ iconPaddingSize, sYIcons + iconPaddingSize,
        		sXScan + iconSize - iconPaddingSize, sYIcons + iconSize - iconPaddingSize);
        drawDrawable(canvas, backgroundRectangle, sXDiscoverable, sYIcons, sXDiscoverable + iconSize, sYIcons + iconSize);
        drawDrawable(canvas, discoverableIcon, sXDiscoverable+ iconPaddingSize, sYIcons + iconPaddingSize,
        		sXDiscoverable + iconSize - iconPaddingSize, sYIcons + iconSize - iconPaddingSize);
    }
    ...
    private void drawConnectStatus(Canvas canvas) {
        //Drawing connection status
        paint.setTextSize(connectStatusTextSize);
        paint.setColor(TEXT_BLACK);
        paint.setTextAlign(Paint.Align.LEFT);
        int textShiftY = centerText() * 2;
        canvas.drawText(connectStatusText,
                startingX, endingY - textShiftY + textPaddingSize*4, paint);
    }
    ...
    private void createBackgroundBitmap(int width, int height) {
        ...
        drawScanAndDiscoverableButton(canvas);
    ...
    private void getLayout(int width, int height) {
        ...
        connectStatusTextSize = (int) (textSize / 2);
        ...
        sXScan = sXUndo - iconSize * 3 / 2 - iconPaddingSize;
        sXDiscoverable = sXScan - iconSize * 3 / 2 - iconPaddingSize;
        resyncTime();
    }
    ...
    public MainView(Context context) {
        ...
        try {
            ...
            connectStatusText = resources.getString(R.string.not_connected);
            ...
            scanIcon = resources.getDrawable(android.R.drawable.ic_menu_search);
            discoverableIcon = resources.getDrawable(android.R.drawable.ic_menu_mylocation);
        ...
        mInputListener = new InputListener(this);
